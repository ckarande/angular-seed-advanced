...
export const getEventCategories: any = compose(fromRegistry._getEventCategoryList, getRegistryState);
export const getEvents: any = compose(fromRegistry._getEventList, getRegistryState);
...
export const getEventCategoryFilter: any = compose(fromRegistry.getEventCategoryFilter, getRegistryState);
export const getEventFilter: any = compose(fromRegistry.getEventFilter, getRegistryState);
...
export const getSelectedEventCategory: any = compose(fromRegistry._getSelectedEventCategory, getRegistryState);
export const getSelectedEvent: any = compose(fromRegistry._getSelectedEvent, getRegistryState);
